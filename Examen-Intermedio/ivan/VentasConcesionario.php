...
include_once("DecoratorConcesionario.php");
...
// MODIFICAR ACA
$concesionario = new DecoratorConcesionario($concesionario);
// HASTA ACA
...
echo "ganancias por Cachavrolet: " . $concesionario->totalGanadoCachavrolet() . "\n";
// Hasta aca