...
include_once("CachavroletDecorator.php");
...
// MODIFICAR ACA
$concesionario = new CachavroletDecorator($concesionario);
// HASTA ACA
...
// MODIFICAR ACA
echo 'Las ganancias de Cachavrolet son: ' . $concesionario->totalGananaciasCachavrolet();
// Hasta aca
