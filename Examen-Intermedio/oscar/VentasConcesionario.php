...
include_once("InterfaceVentas.php");

include_once("Concesionaria.php");
include_once("ConcesionariaDecorada.php");
...
$concesionario= new ConcesionariaDecorada($concesionario);
...
$concesionario->gananciasChevrolet();