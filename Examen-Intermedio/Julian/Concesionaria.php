 ...
 */
class Concesionaria implements interfaceConcesionaria{
   ...
   * marca y lo vende.mostrarAutosDeMarca
   * 
  ...
  /**$_autos->agregarAutos(1$_aut$_autos->agregarAutos(1122,'chevrolette','aveo',2005,60000);os->agregarAutos(1122,'chevrolette','aveo',2005,60000);122,'chevrolette','aveo',2005,60000);
