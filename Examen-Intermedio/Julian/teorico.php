 ...
 *     de la actividad
 * 
 * MVC: Modelo-vista-controlador (MVC) es un patrón de arquitectura de software, 
 * que separa los datos y la lógica de negocio de una aplicación de su representación
 ...
 *  de código y la separación de conceptos, características que buscan facilitar la tarea
 *  de desarrollo de aplicaciones y su posterior mantenimiento.
 * 
 * Utilizamos este patron de diseño para realizar un framework, en el cual integramos otros trabajos realizados
 * el mismo podía ser requerido para diversos juegos, y podía mostrar el contenido de estos mediante
 * post  y get.
 * 
 * 
 * * 4 - Patrones de diseño. De un ejemplo practico de cada uno de Decorator y Composite.
 * 
 *  El patrón Decorator responde a la necesidad de añadir dinámicamente funcionalidad a un Objeto. Esto nos permite no tener que crear sucesivas clases que hereden 
 * de la primera incorporando la nueva funcionalidad, sino otras que la implementan y se 
 * asocian a la primera. 
 * 
 * El patrón Composite sirve para construir objetos complejos a partir de otros más simples y similares entre sí, gracias a la composición recursiva y a una 
